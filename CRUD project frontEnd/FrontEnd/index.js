    ...
    fetch("http://localhost:8081/get")
        ...
        .then(arrayOfAnimals => {
            ...
            arrayOfAnimals.forEach(function(animal) {
                ...
                title.innerText = "Name: " + animal.givenName;
                ...
                updateButton.addEventListener("click", function () {
                    const updateData = {
                        name:prompt("Update the name: ", animal.givenName),
                        type:prompt("Update the type: ", animal.type),
                        price:prompt("Update the price: ", animal.price),
                        sex:prompt("Update the sex: ", animal.sex),
                        colour:prompt("Update the colour: ", animal.colour),
                        date:prompt("Update the date: ", animal.arrival)
                    }
